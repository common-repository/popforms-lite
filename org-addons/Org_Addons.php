                        ...
                        <ul class="plugin-action-buttons">
                            ...
                            <?php
                                ...
                                if(  !in_array( $actuvePluginKey, $activatedPlugins ) && ( in_array( $pluginSlug, $installedPlugins ) || in_array( $sanitizePluginName, $installedPlugins ) ) ) {
                                    ...
                                    echo '<a class="button activate-now" data-slug="'.esc_attr( $pluginSlug ).'" href="'.esc_url( $install_url ).'" aria-label="'.esc_attr( $itemName ).'" data-name="'.esc_attr( $itemName ).'">'.esc_html__( 'Activate', 'popforms' ).'</a>';


                                } else if( in_array( $actuvePluginKey , $activatedPlugins ) ) {

                                echo '<button type="button" class="button button-disabled" disabled="disabled">'.esc_html__( 'Active', 'popforms' ).'</button>';
                                    ...
                                    echo '<a class="install-now button" data-slug="'.esc_attr( $pluginSlug ).'" href="'.esc_url( $install_url ).'" aria-label="Install '.esc_html( $itemName ).' now" data-name="'.esc_html( $itemName ).'">'.esc_html__( 'Install Now', 'popforms' ).'</a>';
                                }
                            ?>
                            </li>
                            <li>
                                ...
                                ?>
                                <a href="<?php echo esc_url( $url ); ?>" class="thickbox open-plugin-details-modal information" aria-label="<?php echo esc_attr( $itemName ); ?>" data-title="<?php echo esc_attr( $itemName ); ?>"><?php esc_html_e( 'More Details', 'popforms' ) ?></a>
                            </li>
                        </ul>            
                    </div>
                </div>
